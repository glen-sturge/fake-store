      ...
      <div className="support-page">
        ...
        <div className="support-content-container">
          ...
          <div className="support-info">
            <h3>Returns</h3>
            <p>
              You have up to 14 days for a full refund. You have an additional
              14 days for store credit.
              <br />
          ...
          <div className="support-info">
            ...
            <p class="support-faq">
              ...
              <br />
              Depending where you are located it take anywhere from 5-10
              business days.
            </p>
            <p class="support-faq">
            ...
            <p class="support-faq">
              ...
              you can still cancel your order. To do so reach out to our team
              via email.
            </p>
            <p class="support-faq">
